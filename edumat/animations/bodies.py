#Different Shapes used in animations written in vPython
from visual import *
...
class tube(object):
    ...
    def buildfaces(self):
        ...
        for i in range(self.incs):
            ...
            # Use these points to make the vertices of two triangles that form each of these
            # reactangles.
            # Find a normal to the rectangle. Store vertices and normals.
            # Repeat for the number of increments you want
            # more increments better visual quality.
...
class frustum(object):
    ...
    def buildfaces(self):
        ...
        for i in range(self.incs):
            ...
            # reactangles.
            # Find a normal to the rectangle. Store vertices and normals.
            # Repeat for the number of increments you want - more increments better
            # visual quality.
            # recursion relations for cosine and sine of (theta+dtheta);
            # avoid lots of trig functions
            newcostheta = costheta*cosdtheta-sintheta*sindtheta
            ...
            snorm1 = dot(p0-p5,p1-p2)*(p0-p5) - (p1-p2)
            snorm2 = dot(p0-p5,p4-p3)*(p0-p5) - (p4-p3)
...
class spherepart(object):
    # This routine draws partial spheres. Mag of axis determines radius,
    # b raises base from halfway pt,
    ...
    def buildfaces(self):
        ...
        for i in range(self.incs):
            ...
            for j in range(self.incs):
                # Calculate four pts that form a small rectangle on each of the surfaces.
                # Use these points to make the vertices of two triangles that form each of
                # these reactangles.
                # Find a normal to the rectangle. Store vertices and normals.
                # Repeat for the number of increments you want
                # more increments better visual quality.
                ...
                p2 = vector(self.r*sinphi,self.r*newcostheta*cosphi,
                self.r*newsintheta*cosphi)
                p3 = vector(self.r*newsinphi,self.r*newcostheta*newcosphi,
                self.r*newsintheta*newcosphi)
                p4 = vector(self.r*newsinphi,self.r*costheta*newcosphi,
                self.r*sintheta*newcosphi)
